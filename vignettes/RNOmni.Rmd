...
```{r A03, include=T, echo=F, fig.width=2*3, fig.height=2*1.5*2, eval=C2}
...
```
```{r C05, echo=F, fig.width=2*3, fig.height=2*1.5*2, eval=C2}
## Plotting
...
Here $k\in(0,1/2)$ is an offset introduced to avoid mapping the sample maximum to infinity. By default, the Blom offset of $k=3/8$ is adopted. 
