...
q = ggplot(data=Q1) + geom_linerange(aes(x=Method,ymin=L,ymax=U)) + geom_point(aes(x=Method,y=y),color="coral",size=1.5);
...
q = ggplot(data=Q2) + geom_linerange(aes(x=Method,ymin=L,ymax=U)) + geom_point(aes(x=Method,y=y),color="royalblue",size=1.5);
q = q + geom_hline(yintercept=0.05,linetype="dashed",color="gray");
q = q + theme_bw() + ylab("Type I Error") + coord_flip();
